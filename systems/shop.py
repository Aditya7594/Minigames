...
def get_user_shop(user_id: str):
    ...
    if not shop_data:
        ...
        shop_images = [f for f in os.listdir('assets/images/shop') if f.endswith('.jpg')]
        ...
        for img in selected_images:
            ...
            daily_cards[card_id] = {
                ...
                'image': f'assets/images/shop/{img}',
...
async def mycollection_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not cards:
        await update.message.reply_text("Your collection is empty. Visit the assets/images/shop to buy some cards!")
        return
...
async def manage_cards(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    card_image = f"assets/images/shop/{card_name}.jpg"
