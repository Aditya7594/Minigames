...
from utils.db import users_collection, multiplayer_games_collection, get_user_by_id
...
game_collection = multiplayer_games_collection
...
def get_user_by_id_cached(user_id):
    """Wrapper for get_user_by_id to match expected function name."""
