...
from utils.db import users_collection, get_user_by_id

# Command throttling settings
# ... (existing throttle code is fine, I'm replacing line 74 onwards mostly)

# DB Alias not needed as we use imported get_user_by_id directly
# But check usages of user_collection
...
# Alias for compatibility if needed, but better to just use get_user_by_id
get_user_by_id_cached = get_user_by_id
