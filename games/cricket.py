...
import os
from utils.db import users_collection, cricket_games_collection, achievements_collection, get_user_by_id, cricket_persistence_collection
...
game_collection = cricket_games_collection
# achievements_collection is already imported
...
async def handle_join_button(update: Update, context: CallbackContext) -> None:
    ...
    try:
        cricket_persistence_collection.update_one(
            {"_id": game_id},
            {
                "$set": {
